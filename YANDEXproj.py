...
jump = pygame.mixer.Sound('kick.ogg')
shoot = pygame.mixer.Sound('shoot.ogg')
tramp = pygame.mixer.Sound('trampol.ogg')
spring = pygame.mixer.Sound('springboing.ogg')
mons = pygame.mixer.Sound('Monster.ogg')
mons.set_volume(0.01)
...
class Monster(pygame.sprite.Sprite):
    image = load_image("monster.png", 100, 100, (255, 255, 255))
...
class Trampoline(Platform):
    image = load_image('batut.jpg', 55, 20)
...
class Spring(Platform):
    image = load_image('PLPR.jpg', 55, 20)
...
class Cur(pygame.sprite.Sprite):
    image = load_image("hero.jpg", 40, 40)
...
class GameOver(pygame.sprite.Sprite):
    car_image = load_image("GameOver.jpg", *size)
...
def start_screen():
    s = ['Game3.jpg', 'Game2.jpg', 'Game1.jpg', 'GameLetsGo.jpg', 'GameLetsGo.jpg']
    idx = 0
